...
See [Customization](/oss/python/deepagents/customization#middleware) for the [default middleware stack](/oss/python/deepagents/customization#default-stack-main-agent) and for adding [custom middleware](/oss/python/langchain/middleware). See the [LangChain context engineering](/oss/python/langchain/context-engineering#system-prompt) guide for examples.
